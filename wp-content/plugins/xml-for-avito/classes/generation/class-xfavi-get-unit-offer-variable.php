...
/**
 * Class Get_Unit_Offer_Variable for variable products
 *
...
class XFAVI_Get_Unit_Offer_Variable extends XFAVI_Get_Unit_Offer {
	use XFAVI_T_Common_Ad;
	use XFAVI_T_Common_Contact_Info;
	use XFAVI_T_Common_Get_CatId;
	use XFAVI_T_Common_Skips;

	use XFAVI_T_Variable_Get_Adtype;
	use XFAVI_T_Variable_Get_Apparel;
	use XFAVI_T_Variable_Get_Appareltype;
	use XFAVI_T_Variable_Get_Brand;
	use XFAVI_T_Variable_Get_Category;
	use XFAVI_T_Variable_Get_Color;
	use XFAVI_T_Variable_Get_Condition;
	use XFAVI_T_Variable_Get_Generation;
	use XFAVI_T_Variable_Get_Forwhom;
	use XFAVI_T_Variable_Get_Description;
	use XFAVI_T_Variable_Get_Goods_Sub_Type;
	use XFAVI_T_Variable_Get_Goods_Type;
	use XFAVI_T_Variable_Get_Id;
	use XFAVI_T_Variable_Get_Image;
	use XFAVI_T_Variable_Get_Make;
	use XFAVI_T_Variable_Get_Material;
	use XFAVI_T_Variable_Get_Mechanism;
	use XFAVI_T_Variable_Get_Model;
	use XFAVI_T_Variable_Get_OEM;
	use XFAVI_T_Variable_Get_Price;
	use XFAVI_T_Variable_Get_ProductSubType;
	use XFAVI_T_Variable_Get_Size;
	use XFAVI_T_Variable_Get_Title;
	...
	public function generation_product_xml( $result_xml = '' ) {
		...
		$result_xml = apply_filters( 'xfavi_append_variable_offer_filter', $result_xml, $this->product, $this->offer, $this->get_feed_id() );

		$result_xml = apply_filters(
			'x4avi_f_append_variable_offer',
			$result_xml,
			[ 
