...
trait XFAVI_T_Simple_Get_Appareltype {
	public function get_appareltype($tag_name = 'ApparelType', $result_xml = '') {
		...
		$result_xml_appareltype = apply_filters('xfavi_simple_result_xml_appareltype', $result_xml_appareltype, $product, $this->get_feed_id());
