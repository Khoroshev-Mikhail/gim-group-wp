		...
		public function __construct( $pref = '' ) {
			...
			$plugins_arr = [ 
				[ 
					...
					'desc' => __( 'Сreates a XML-feed to upload to Google Merchant Center', 'xml-for-avito' ),
				...
				[ 
					...
					'desc' => __( 'Imports products from YML to your shop', 'xml-for-avito' ),
				...
				[ 
					...
					'desc' => __( 'Сreates a XML-feed for importing your products to Hotline', 'xml-for-avito' ),
				...
				[ 
					'name' => 'XML for Avito',
					'desc' => __( 'Сreates a XML-feed for importing your products to', 'xml-for-avito' ),
					'url' => 'https://wordpress.org/plugins/xml-for-avito/'
				],
				[ 
